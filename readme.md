...
This is a library which you can use to interface with your skyRC charger. It has only been tested with the D100V2 and will throw an error if it detects a different model. This is only done to ensure your charger is not damaged, and I presume the code should work - I just havent tested it.
